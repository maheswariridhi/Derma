    ...
    >
      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="text-right">
          {patient.condition && <p className="text-sm font-medium text-gray-900">{patient.condition}</p>}
          {patient.lastVisit && <p className="text-xs text-gray-500">Last visit: {patient.lastVisit}</p>}
        </div>
      </div>
